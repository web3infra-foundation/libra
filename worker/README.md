...
| `docs/improvement/publish.md` | Design / phased rollout for the publish surface |
| `docs/improvement/publish-worker-design-handoff.md` | Frozen worker-surface accept contract (routes / components / deviations) |

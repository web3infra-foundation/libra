...
rust_binary(
    ...
    deps = [
        ...
        "//third-party/rust/crates/libvault/0.2.2:libvault",
        "//third-party/rust/crates/lru-mem/0.3.0:lru-mem",
        "//third-party/rust/crates/mime_guess/2.0.5:mime_guess",
        "//third-party/rust/crates/object_store/0.13.1:object_store",
        "//third-party/rust/crates/once_cell/1.21.4:once_cell",
        "//third-party/rust/crates/openssl/0.10.76:openssl",
        "//third-party/rust/crates/path-absolutize/3.1.1:path-absolutize",
        "//third-party/rust/crates/pathdiff/0.2.3:pathdiff",
        "//third-party/rust/crates/pulldown-cmark/0.13.1:pulldown-cmark",
        "//third-party/rust/crates/ratatui/0.30.0:ratatui",
        ...
        "//third-party/rust/crates/tokio-tungstenite/0.28.0:tokio-tungstenite",
        ...
        "//third-party/rust/crates/wax/0.7.0:wax",
        ":libra-lib",
    ],
)

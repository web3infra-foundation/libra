...
| `ai_subagent_parallel_test` | 2 | CEX-S2-14 scheduler-side controlled parallelism admission: disjoint write scopes spawn up to `max_parallel`, over-capacity runs queue, overlapping write scopes enter the conflict queue and promote after completion | `src/internal/ai/agent_run/parallel.rs` |

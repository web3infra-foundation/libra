...
This document preserves the original design notes for the unpublished `stats` implementation. It is not a user-visible command contract and is not tracked in `COMPATIBILITY.md`.

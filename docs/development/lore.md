...
| 1.2 | `restore --ours/--theirs` | 已有 index stages 1/2/3 可读，属于低风险高价值项 | 确认 rebase 冲突路径也写 stages |
| 1.3 | diff3 conflict markers、`merge --dry-run`、`--restart` | merge state 已有 base/target/orig_head，可内存演算；文件写入路径需隔离 | 1.2 |

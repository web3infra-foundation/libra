...
- 标记 `docs/commands/code.md`、README、`docs/automation/local-tui-control.md`、`docs/improvement/web.md` 中所有 TUI-default 文案。

Exit criteria:

- 有一张迁移清单，每个 TUI-owned 行为都有目标模块和测试目标。
- `rg "TUI|tui|--web-only|--stdio" docs/commands/code.md README.md docs/automation docs/improvement/web.md` 的待改位置已确认。
...
- 将 `docs/automation/local-tui-control.md` 重命名或改写为 local Code UI automation control；同步 docs consistency script。
...
- `docs/commands/README.md`
- `docs/automation/local-tui-control.md`（重命名或改写）

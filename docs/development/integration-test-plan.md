...
| History | log, shortlog, show, show-ref, ls-remote, ls-tree, diff, grep, blame, describe | supported/partial | 优秀（inspection 全） | cli.commit-status-log, cli.object-readback, cli.ls-tree-smoke, cli.grep-blame-describe-shortlog | 真实远端 refs 见 Wave3 |

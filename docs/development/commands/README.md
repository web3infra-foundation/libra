...
| [`rev-list`](rev-list.md) | `partial` | multi-revision reachability, exclusions/ranges, count/limit controls, author/committer/time filters, parent filters/reset aliases, first-parent traversal, parents and timestamp output supported; advanced traversal filters not exposed |

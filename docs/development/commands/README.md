...
| [`rev-list`](rev-list.md) | `partial` | multi-revision reachability, exclusions/ranges, count/limit controls, time filters, parent filters/reset aliases, parents and timestamp output supported; advanced traversal filters not exposed |

...
| [`branch`](branch.md) | `partial` | create/list/delete/rename/upstream set+unset/current/contains/points-at/merged/no-merged/ignore-case supported; copy/description/sort/format not exposed |

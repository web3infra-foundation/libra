...
| [`config`](config.md) | `partial` | vault-backed local/global config plus section operations (`--remove-section`/`--rename-section`); system scope, editor round-trip, typed conversion and NUL output incomplete |

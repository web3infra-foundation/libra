...
- Synopsis：`libra diff [--staged | --cached] [--old <COMMIT> --new <COMMIT>] [<commit>..<commit>] [--stat | --numstat | --shortstat | --name-only | --name-status | --summary] [-s | --no-patch] [--exit-code] [--check] [-R] [-a | --text] [--no-ext-diff] [--no-color-moved] [--no-renames] [--no-relative] [--no-indent-heuristic] [--no-textconv] [-z] [<pathspec>...]`。

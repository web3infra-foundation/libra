...
- **当前代码证据**：[`src/command/push.rs:1318`](../../../src/command/push.rs#L1318) 已有 "submodule is not supported yet" 警告；[`README.md:572`](../../../README.md#L572) 明确声明 Libra 不提供 submodule / subtree。

...
- [ ] full TUI 仍待补齐：v0.17.83 已新增 `/usage` SQLite-backed detail popup、UsageUpdated 刷新和 render snapshot；streaming token incremental refresh 与配置开关仍未完成。

...
|-------|-----------|---------|----------|
| Phase 0 Contract Stabilization | 100% | ~80% | `write_intent` + `write_context_snapshot_if_needed` Phase 0 formal-write surface 全部落地（v0.17.594）；`Phase0Input` struct 是否在 contracts.rs 完整定义待核 |
